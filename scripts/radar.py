...
def from_github(user: str, token: str | None, limit: int, exclude: set[str],
    ...
    if not totals:
        print(f"No live language data found for '{user}', using fallback repos", file=sys.stderr)
        totals = {"Python": 45000, "TypeScript": 40000, "JavaScript": 35000, "HTML": 12000, "CSS": 10000}
